...
#define MSGPACK_ARCH_PPC_64 MSGPACK_VERSION_NUMBER_NOT_AVAILABLE

#if defined(__powerpc64__) || defined(__ppc64__) || defined(__PPC64__) || \
    defined(_ARCH_PPC64)
#   undef MSGPACK_ARCH_PPC_64
#   define MSGPACK_ARCH_PPC_64 MSGPACK_VERSION_NUMBER_AVAILABLE
#endif

#if MSGPACK_ARCH_PPC_64
#   define MSGPACK_ARCH_PPC_64_AVAILABLE
#endif

#define MSGPACK_ARCH_PPC_64_NAME "PowerPC64"
...
#include <rpc/msgpack/predef/detail/test.h>
MSGPACK_PREDEF_DECLARE_TEST(MSGPACK_ARCH_PPC_64,MSGPACK_ARCH_PPC_64_NAME)
