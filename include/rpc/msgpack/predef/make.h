...
/* tag::reference[]
* `MSGPACK_PREDEF_MAKE_10_VVPPP(V)`
*/ // end::reference[]
#define MSGPACK_PREDEF_MAKE_10_VVPPP(V) MSGPACK_VERSION_NUMBER(((V)/1000)%100,0,(V)%1000)
/* tag::reference[]
...
= `MSGPACK_PREDEF_MAKE_*..` date macros
